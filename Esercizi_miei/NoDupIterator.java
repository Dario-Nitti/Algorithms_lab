...
public class NoDupIterator {
    ...
    public <E extends Comparable<? super E>> Iterator<E> noDupSort(Iterator<E> it){
    ...
    public <E> Iterator<E> noDup(Iterator<E> it){
    ...
    public void run()  //test
    {
        ...
        System.out.println ("\nArrayList (NoDup):");
        itr = lista.iterator();
        Iterator<String> itrNoDup = this.<String>noDup( itr );
        while (itrNoDup.hasNext()) System.out.println (itrNoDup.next());

        System.out.println ("\nArrayList (NoDupSort):");
        itr = lista.iterator();
        itrNoDup = this.<String>noDupSort( itr );
        while (itrNoDup.hasNext()) System.out.println (itrNoDup.next());
