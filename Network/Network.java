...
public class Network<Vertex extends Comparable<? super Vertex>> implements Graph<Vertex, Double>
{
        ...
        {
                int count = 0;
                // computes the sum of the size of all Neighbor Maps
                // (each pair is associated with one edge)
        ...
        public Double getEdgeWeight (Vertex v1, Vertex v2)
        {
                ...
                if (! (adjacencyMap.containsKey (v1) && adjacencyMap.containsKey (v2)))
                        return null;
                // the value associated with edge v1 in adjacencyMap is a treeMap (neighborMap)
                TreeMap<Vertex, Double> neighborMap = adjacencyMap.get (v1);
                // the value associated with edge v2 in neighborMap is the weight of edge <v1, v2>
                return neighborMap.get (v2);  // if there is no edge <v1, v2> weight will be null
        ...
        /**
         *  Determines if this (directed) Network object is (strongly) connected.
